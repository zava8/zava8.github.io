...
////////////////
const itekst = ref("#hscii font -> ɦin5.ttf (ɦiनꟈi) (31=8+8+5+6+4) :- 8αiueoꞇgh_8άđнтṅkvz 5टडपबस(टh डh पh बh सh) 6यरलमनफ +4jqwx. त=ᴛ=τ≠t");
const otekst = ref("");
const ztrdir = ref("");
const olc = ref(0);
...
<template>
  <div class="main" id="ztrapp">
      ...
      <div>
		uniꞇode_to_iṅglish (अहṅदत=AHNDT=ᴀнṅđᴛ=àɦṅꟈτ≠αhndt  त=ᴛ=τ≠t):<br/>
